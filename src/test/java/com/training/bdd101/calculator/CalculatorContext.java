...
import com.training.bdd101.calculator.Calculator;

/**
 * The CalculatorContext uses a ThreadLocal to shared information between threads.
 * It can be used to store application between steps.
 * @author 1373592
 *
 */
